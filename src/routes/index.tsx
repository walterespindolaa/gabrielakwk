...
/* ─── FAQ ─── */
const faqs = [
  { q: "Nunca postei nada. Essa consultoria é para mim?", a: "Sim. O Método CRIAR foi pensado também para quem está começando do zero. Você não precisa ter histórico de conteúdo, seguidores ou perfil ativo — precisa ter vontade de começar com clareza. O processo parte inteiramente de quem você é, não do que você já publicou." },
  { q: "Já contratei social media antes e me frustrei.", a: "Faz sentido. A maioria das entregas de social media é execução sem estratégia — posts bonitos que não refletem quem você é, feitos por alguém que não entendeu o seu negócio de verdade. Aqui o ponto de partida é o oposto: antes de qualquer conteúdo, a gente constrói o posicionamento. Você sai com algo que é seu — não com um feed que depende de outra pessoa para continuar existindo." },
  { q: "Preciso aparecer em vídeo?", a: "Não necessariamente. A consultoria não pressupõe nenhum formato específico. Trabalhamos juntas para encontrar a forma de comunicação que faz sentido para a sua realidade — inclusive se você ainda não se sente confortável na câmera." },
  ...
  { q: "Vou sair da consultoria sabendo exatamente o que fazer?", a: "Sim. Os encontros finais são dedicados à ativação e à organização da rotina: funil de conteúdo, linha editorial, ideias de posts com títulos prontos, plano dos próximos 90 dias e a reorganização da sua casa digital para sustentar tudo com autonomia. Além disso, você recebe um relatório completo com tudo que foi construído ao longo dos 5 encontros — do posicionamento ao plano de execução. E ainda tem 30 dias de suporte via WhatsApp depois." },
